...
TEST_N_CRITERIA=[
    ...
    ('http://localhost:8080/collections/urn:nasa:pds:izenberg_pdart13_meap:data_eetable::1.0/products',200,0),
    ...
    ('http://localhost:8080/products/urn:nasa:pds:izenberg_pdart13_meap:data_eetable:ele_evt_8hr_orbit_2012-2013::1.0/bundles',200,0),
    ...
    ('http://localhost:8080/products/urn:nasa:pds:izenberg_pdart13_meap:data_eetable:ele_evt_8hr_orbit_2012-2013::1.0/collections',200,0),
    ]
